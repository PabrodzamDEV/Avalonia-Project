...
public class Movie
{
    ...
    public char Watched { get; set; } // Determines if the movie has been watched
    ...
    public Movie(int ReleaseDate, float ImdbScore, bool AdultContent, char Watched, string Title, string Director, string Genre, byte[] Cover)
    {
        ...
        this.Watched = Watched != default(char) ? Watched : throw new ArgumentNullException(nameof(Watched));
